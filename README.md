...
🚧 **Early development — the repo is brand new.**

Right now this is a vision document and a starting point. The first steps are:

- [ ] Project architecture and repo structure
- [ ] Basic Bevy scene with orbital mechanics
